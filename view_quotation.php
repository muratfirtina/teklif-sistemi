...
?>
    <style>
        .info-card { /* view_invoice.php'den alındı */
        ...
        .status-badge {
            ...
            vertical-align: middle; /* Başlıkla aynı hizada durması için */
        }
        .action-buttons {
            margin-bottom: 15px;
        }
        .action-buttons .btn, .action-buttons .btn-group {
            margin-right: 5px;
            margin-bottom: 5px; /* Küçük ekranlarda alt alta gelince boşluk */
        }
    </style>
                ...
                <div class="action-buttons">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item <?php echo $quotation['status'] == 'draft' ? 'active' : ''; ?>" href="quotations.php?updateStatus=<?php echo $quotation_id; ?>&status=draft">Taslak</a></li>
                            <li><a class="dropdown-item <?php echo $quotation['status'] == 'sent' ? 'active' : ''; ?>" href="quotations.php?updateStatus=<?php echo $quotation_id; ?>&status=sent">Gönderildi</a></li>
                            <li><a class="dropdown-item <?php echo $quotation['status'] == 'accepted' ? 'active' : ''; ?>" href="quotations.php?updateStatus=<?php echo $quotation_id; ?>&status=accepted">Kabul Edildi</a></li>
                            <li><a class="dropdown-item <?php echo $quotation['status'] == 'rejected' ? 'active' : ''; ?>" href="quotations.php?updateStatus=<?php echo $quotation_id; ?>&status=rejected">Reddedildi</a></li>
                    ...
                    <div class="col-lg-4 col-md-5">
                        ...
                        <div class="info-card">
                            ...
                            <dl class="row mb-0">
                                ...
                                <dd class="col-sm-7"><a href="view_customer.php?id=<?php echo $customer['id']; ?>"><?php echo htmlspecialchars($customer['name']); ?></a></dd>
                        ...
                        <div class="info-card">
                            ...
                            <dl class="row mb-0">
                                ...
                                <dd class="col-sm-6 text-end"><?php echo number_format($quotation['subtotal'], 2, ',', '.') . ' ₺'; ?></dd>
                                <dt class="col-sm-6">İndirim:</dt>
                                <dd class="col-sm-6 text-end"><?php echo number_format($quotation['discount_amount'], 2, ',', '.') . ' ₺'; ?></dd>
                                <dt class="col-sm-6">KDV:</dt>
                                <dd class="col-sm-6 text-end"><?php echo number_format($quotation['tax_amount'], 2, ',', '.') . ' ₺'; ?></dd>
                                <hr class="my-1">
                                <dt class="col-sm-6 fw-bold fs-5">Genel Toplam:</dt>
                                <dd class="col-sm-6 text-end fw-bold fs-5"><?php echo number_format($quotation['total_amount'], 2, ',', '.') . ' ₺'; ?></dd>
                            </dl>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <?php if (!empty($quotation['terms_conditions'])): ?>
                                     <div class="col-md-<?php echo !empty($quotation['notes']) ? '6' : '12'; ?>">
                                        <div class="card mb-4">
                                            <div class="card-header"><h5 class="card-title mb-0">Şartlar ve Koşullar</h5></div>
                                            <div class="card-body">
