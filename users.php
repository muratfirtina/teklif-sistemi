                                ...
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php elseif ($user['role'] == 'production'): ?>
                                                <span class="badge bg-warning role-badge">Üretim</span>
                                            <?php else: ?>
                    ...
                    <div class="mb-3">
                            ...
                            <select class="form-select" id="role" name="role" required>
                                <option value="user" <?php echo (isset($role) && $role == 'user') ? 'selected' : ''; ?>>
                                    Kullanıcı</option>
                                <option value="production" <?php echo (isset($role) && $role == 'production') ? 'selected' : ''; ?>>Üretim</option>
