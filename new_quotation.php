...
<style>
    .item-row {
    border: 1px solid #dee2e6; /* İnce bir kenarlık ekle */
    padding: 15px;             /* İç boşluk ver */
    margin-bottom: 15px;       /* Altına boşluk ekle (kalemler arasına) */
    border-radius: 0.375rem;   /* Köşeleri hafif yuvarla (Bootstrap standardı) */
    background-color: #f8f9fa; /* Opsiyonel: Hafif bir arka plan rengi */
}

/* Opsiyonel: Kaldır butonunu biraz daha belirginleştirmek için */
.item-row .remove-item {
    margin-top: 5px; /* Diğer inputlarla hizalamak için küçük bir üst boşluk */
}
                       ...
                       <select class="form-select" id="customer_id" name="customer_id" required>
                           ...
                           <?php endforeach; ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="terms_conditions" name="terms_conditions" rows="3"><?php echo isset($terms_conditions) ? htmlspecialchars($terms_conditions) : '1. Bu teklif 30 gün geçerlidir.
2. Fiyatlara KDV dahil değildir.
3. Ödeme şartları: %50 peşin, %50 teslimat öncesi.
4. Teslimat süresi: Sipariş onayından itibaren 10 iş günüdür.'; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <button type="button" class="btn btn-secondary me-md-2" onclick="window.location.href='quotations.php'">İptal</button>
        ...
        <div class="item-row">
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control item-price" name="unit_price[]" step="0.01" min="0" value="0.00" required>
                </div>
                <div class="col-md-2">
                    <label class="form-label">İndirim %</label>
                    <input type="number" class="form-control item-discount" name="discount_percent[]" step="0.01" min="0" max="100" value="0">
                </div>
                <div class="col-md-2">
